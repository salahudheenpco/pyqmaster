...
export const bitsatLinearProgrammingQuestions: PYQQuestion[] = [
  {
    ...
    correctAnswer: "79",
    explanation: {
      quick: "Use the main concept from Maximum value of an objective function under linear constraints and apply it directly. The correct answer is 79.",
      standard: "We solve this using the main idea from Maximum value of an objective function under linear constraints. First identify what the question is asking, then use the correct rule, formula, or concept step by step. After substituting the given information carefully, we get the final answer as 79.",
