...
export const bitsatStatesOfMatterQuestions: PYQQuestion[] = [
  {
    ...
    explanation: {
      quick: "Use the main concept from Deviation from ideal gas behaviour and apply it directly. The correct answer is high pressure and low temperature.",
      standard: "We solve this using the main idea from Deviation from ideal gas behaviour. First identify what the question is asking, then use the correct rule, formula, or concept step by step. After substituting the given information carefully, we get the final answer as high pressure and low temperature.",
